...
public class MainActivity extends AppCompatActivity {
    ...
    String API_CHECKOUT ="http://tipsscorepro.com/pay/checkout.php";
    String API_GET_TOKEN ="http://tipsscorepro.com/pay/main.php";
    ...
    private class getToken extends AsyncTask {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mDailog=new ProgressDialog(MainActivity.this,android.R.style.Theme_DeviceDefault_Light_Dialog);
